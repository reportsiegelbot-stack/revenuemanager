...
| `importa_log_disponibilita.py` | Importa un log di disponibilita' compilato a mano (CSV esportato da un foglio Google) in alternativa a `snapshot_oggi.py`. Ad ogni importazione controlla automaticamente la coerenza dei dati (date, duplicati, salti anomali di disponibilita' o prezzo) e mostra un riepilogo con gli eventuali avvisi da verificare a occhio: non blocca mai l'importazione, segnala e basta. |
